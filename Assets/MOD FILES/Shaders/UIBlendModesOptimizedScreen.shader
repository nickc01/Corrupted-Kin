		...
		Pass {
			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					uniform  sampler2D _GUIBlendingSharedGT;
					in  vec4 vs_COLOR0;
					...
					void main()
					{
					    ...
					    u_xlat1.x = u_xlat10_0.w * vs_COLOR0.w + -0.00999999978;
					    ...
					    u_xlat10_1 = texture(_GUIBlendingSharedGT, u_xlat1.xz);
					    u_xlat16_1.xyz = (-u_xlat10_1.xyz) + vec3(1.0, 1.0, 1.0);
					    u_xlat0.xyz = (-u_xlat10_0.xyz) * vs_COLOR0.xyz + vec3(1.0, 1.0, 1.0);
					    u_xlat6 = u_xlat10_0.w * vs_COLOR0.w;
					    SV_Target0.w = u_xlat6;
					    SV_Target0.xyz = (-u_xlat16_1.xyz) * u_xlat0.xyz + vec3(1.0, 1.0, 1.0);
					    return;
					}"
				}
			}

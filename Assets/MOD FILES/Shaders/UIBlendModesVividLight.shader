			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat1.xyz = u_xlat10_2.xyz / u_xlat5.xyz;
					    ...
					    u_xlatb4.xyz = lessThan(vec4(0.5, 0.5, 0.5, 0.5), u_xlat0.yzww).xyz;
					    SV_Target0.w = u_xlat0.x;
					    SV_Target0.x = (u_xlatb4.x) ? u_xlat1.x : u_xlat2.x;
					    SV_Target0.y = (u_xlatb4.y) ? u_xlat1.y : u_xlat2.y;
					    SV_Target0.z = (u_xlatb4.z) ? u_xlat1.z : u_xlat2.z;
					    return;
					}"
				}
			}
